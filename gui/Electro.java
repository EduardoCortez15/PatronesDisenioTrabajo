 ...
 * @author ASUS
 */
public class Electro extends javax.swing.JPanel {
    ...
    private void MostrarImagenes() {
        ...
        this.addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                setImageLabel(licuadora, "src/Imagenes1/Licuadora.jpg");
                setImageLabel(refri, "src/Imagenes1/fridge.png");
                setImageLabel(aire, "src/Imagenes1/airConditioner.jpg");
                setImageLabel(ventilador, "src/Imagenes1/ventiladora.jpg");
                setImageLabel(microondas, "src/Imagenes1/Microondas.jpg");
                setImageLabel(aspiradora, "src/Imagenes1/aspiradora.jpg");
            }
        });
    }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        Producto1 p6 = new Producto1.ProductoBuilder(1, "Refrigeradora", "Electro", 1200).build();
        Producto1 p4 = new Producto1.ProductoBuilder(1, "Licuadora", "Electro", 350).build();
        Producto1 p2 = new Producto1.ProductoBuilder(1, "Aire Acondicionado", "Electro", 1500).build();
        Producto1 p1 = new Producto1.ProductoBuilder(1, "Aspiradora", "Electro", 800).build();
        Producto1 p5 = new Producto1.ProductoBuilder(1, "Microondas", "Electro", 500).build();
        Producto1 p3 = new Producto1.ProductoBuilder(1, "Ventiladora", "Electro", 300).build();
