...
import factory.FabricaKali;
import factory.FabricaLondon;
...
public class Muebles extends javax.swing.JPanel {
    ...
    private void MostrarImagenes() {
        ...
        this.addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                setImageLabel(Silla1, "src/Imagenes1/silla1.jpg");
                setImageLabel(Sofa1, "src/Imagenes1/sofa1.jpg");
                setImageLabel(Mesa1, "src/Imagenes1/mesa1.jpg");
                //setImageLabel(Sofa2, "src/main/java/Imagenes/sofa2.jpg");
                setImageLabel(Silla2, "src/Imagenes1/silla2.jpg");
                setImageLabel(Sofa2, "src/Imagenes1/sofa2.jpg");
                setImageLabel(Mesa2, "src/Imagenes1/mesa2.jpg");
            }
        });
    }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        Producto1 mesa = fabrica.crearMesa();
        Producto1 silla = fabrica.crearSilla();
        Producto1 sofa = fabrica.crearSofa();
        FabricaMuebles fabrica2 = new FabricaKali();
        Producto1 mesa2 = fabrica2.crearMesa();
        Producto1 silla2 = fabrica2.crearSilla();
        Producto1 sofa2 = fabrica2.crearSofa();
