...
public class App extends javax.swing.JFrame {
   ...
   // public static DefaultListModel<Producto> carritoModel = new DefaultListModel<>();
    public static List<Producto1> lista = new ArrayList<>();
    ...
    void SubirImagenes(){
        ...
        setImageLabel(bebidas, "src/Imagenes/bebidas.jpg");
        setImageLabel(Tecnologia, "src/Imagenes/tecnologia.jpg");
        setImageLabel(Electro, "src/Imagenes/electro.jpg");
        setImageLabel(muebles, "src/Imagenes/muebles1.jpg");
        setImageLabel(Abarrotes, "src/Imagenes/abarrotes.jpg");
        setImageLabel(Camara, "src/Imagenes/limpieza.jpg");
        setImageButton(btnHome, "src/Imagenes1/home1.png");
        setImageButton(btnUser, "src/Imagenes1/user.png");
        setImageButton(btnCart, "src/Imagenes1/cart1.png");
    }
    void InitStyle(){
